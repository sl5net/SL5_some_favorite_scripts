...
echo "=== Automatisches Setup-Skript für NFS-Mount (RADIKAL VEREINFACHTER PFAD) ==="
echo ""

# ---- NEUE Konfiguration ----
LOCAL_MOUNT_POINT="/mnt/ix4share" # SEHR EINFACHER NAME!
NAS_IP="[YourNASip]"
NFS_EXPORT_PATH="/nfs/share"

# Dateinamen für die systemd-Units (abgeleitet vom NEUEN Mountpunkt)
# /mnt/ix4share -> mnt-ix4share
MOUNT_UNIT_FILENAME="mnt-ix4share.mount"
AUTOMOUNT_UNIT_FILENAME="mnt-ix4share.automount"
...
# Für /mnt/ix4share: mnt-ix4share (kein Escaping in der Shell nötig, wenn keine Sonderzeichen im Namen sind)
UNIT_NAME_FOR_COMMANDS="mnt-ix4share" # Basisname
...
# Da UNIT_NAME_FOR_COMMANDS jetzt keine Zeichen enthält, die die Shell escapen müsste,
