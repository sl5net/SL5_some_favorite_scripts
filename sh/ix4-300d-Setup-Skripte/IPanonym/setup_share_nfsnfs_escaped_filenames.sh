...
echo "=== Experimentelles Setup V2: NFS-Mount für /mnt[YourNASMount]/share_nfs ==="
echo "=== mit '\\x2d' direkt im Unit-Dateinamen ==="
echo ""

# ---- Konfiguration ----
LOCAL_MOUNT_POINT="/mnt[YourNASMount]/share_nfs"
NAS_IP="[YourNASip]"
...
MOUNT_UNIT_FILENAME_LITERAL='mnt-ix4\x2d300d-share_nfs.mount'
AUTOMOUNT_UNIT_FILENAME_LITERAL='mnt-ix4\x2d300d-share_nfs.automount'
...
UNIT_NAME_FOR_SHELL_COMMANDS='mnt-ix4\x2d300d-share_nfs' # Basisname
